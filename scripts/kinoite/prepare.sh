...
curl -Lo /etc/yum.repos.d/hazel-bunny-ricing-fedora-40.repo https://copr.fedorainfracloud.org/coprs/hazel-bunny/ricing/repo/fedora-40/hazel-bunny-ricing-fedora-40.repo && \
sed -i 's@enabled=0@enabled=1@g' /etc/yum.repos.d/hazel-bunny-ricing-fedora-40.repo && \
